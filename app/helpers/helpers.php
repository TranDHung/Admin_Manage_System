...
if(!function_exists('get_settings')){
    function get_settings() {
        ...
        if($settings_data) {
            ...
            $settings->insert([
                'site_name'=>'Mini-Laravel',
                'site_email'=>'admin@laravecom.test'
            ]);
...
if(!function_exists('get_social_network')){
    function get_social_network() {
        ...
        $socials_data = $socials->first();

        if($socials_data) {
            $results =$socials_data;
        }else{
            $socials->insert([
                'github_url' =>null,
                'youtube_url' =>null,
            ...
            $new_socials_data = $socials->first();
            $results = $new_socials_data;
        }
        return $results;
    }
}